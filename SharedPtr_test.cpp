...
void basic_tests_1() {
    ...
    #if 0
    Comment out because this got accidentally left out of the assignment.
    ...
    size_t base = AllocatedSpace;
    {
        ...
        // More misc tests.
        {
            ...
            */
            ...
            #if 0
            Commented out because it was accdidentally left out of the assignment.
            // Dynamic downcast.
